        ...
        <div className="home-content-service">
            ...
            <div className="services">
                <div className="residence">
                    <img className="pet-img" src="https://i.natgeofe.com/n/f0dccaca-174b-48a5-b944-9bcddf913645/01-cat-questions-nationalgeographic_1228126_4x3.jpg" />
                    <NavLink className="nav-link" to={'/pricing'}>
                    <h4>ПРОЖИВАНИЕ</h4>
                    </NavLink>
                    <p>Собаки и кошки живут в своих удобных отдельных <br /> апартаментах.</p>
                </div>
                <div className="residence">
                    <img className="pet-img" src="https://www.dogslife.com.au/wp-content/uploads/2018/10/1-3.jpg" />
                    <NavLink className="nav-link" to={'/pricing'}>
                    <h4>ИГРЫ</h4>
                    </NavLink>
                ...
                <div className="residence">
                    <img className="pet-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwf-Qysi-Qm25ATjGve9a1Z0XUS_AQLx9_-hEWmmuzWDXW45q-K4XumcjrkO9N9nFWG7E&usqp=CAU" />
                    <h4>ВЕЧЕРИНКА</h4>
